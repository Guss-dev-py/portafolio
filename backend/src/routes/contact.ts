  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0f1117;padding:40px 20px;">
        ...
        <tr>
          <td style="background:#16171d;padding:36px 40px;border-left:1px solid #2a2d3a;border-right:1px solid #2a2d3a;">
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
              <tr>
                <td style="background:#1e1f28;border-radius:8px;padding:16px 20px;">
                  ...
                  <p style="margin:0;font-size:17px;font-weight:600;color:#f3f4f6;">${safeName}</p>
                </td>
              </tr>
            </table>
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
              <tr>
                <td style="background:#1e1f28;border-radius:8px;padding:16px 20px;">
                  ...
                  <a href="mailto:${safeEmail}" style="margin:0;font-size:15px;color:#a855f7;text-decoration:none;font-weight:500;">${safeEmail}</a>
                </td>
              </tr>
            </table>
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="background:#1e1f28;border-radius:8px;padding:20px;border-left:3px solid #a855f7;">
                  ...
                  <p style="margin:0;font-size:15px;color:#d1d5db;line-height:1.75;">${safeMessage}</p>
                </td>
              </tr>
            </table>
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:28px;">
              <tr>
                <td align="center">
                  <a href="mailto:${safeEmail}?subject=Re: mensaje desde tu portafolio" style="display:inline-block;background:linear-gradient(135deg,#7c3aed,#a855f7);color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;padding:12px 32px;border-radius:8px;letter-spacing:0.2px;">Responder a ${safeName}</a>
                </td>
              </tr>
            </table>
          </td>
    ...
    const [result] = await Promise.all([
      ...
      resend.emails.send({
        ...
        html: emailHtml,
      }).catch((emailErr: unknown) => console.error('Error enviando email:', emailErr)),
    ]);
